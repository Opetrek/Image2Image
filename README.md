...
## Контакты для связи по поводу проекта для его улучшения.
 Если по ходу работы возникли вопросы, замечания, или пожелания как улучшить проект, можете связаться по контакту:
1. **Разработчик**
 [ссылка](https://vk.com/t1m_ka)
